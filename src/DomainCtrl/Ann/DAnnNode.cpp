...
NStatus DAnnNode::train() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::search() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::insert() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::update() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::remove() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::loadModel() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::saveModel() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::edition() {
    NAO_NO_SUPPORT
}


NStatus DAnnNode::refreshParam() {
    NAO_NO_SUPPORT
}
