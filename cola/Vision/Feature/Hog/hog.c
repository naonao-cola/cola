...
static void vl_hog_prepare_buffers(VlHog* self, vl_size width, vl_size height, vl_size cellSize)
{
    ...
    if (self->hog && self->hogWidth == hogWidth && self->hogHeight == hogHeight) {
        ...
        if (self->transposed) {
          ...
          factor4 = 1.0 / VL_MAX(sqrt(norm5 + norm6 + norm8 + norm9), 1e-10) ;
                ...
                case VlHogVariantUoctti:
                    ...
                    *oiter = (1.0f / sqrtf(18.0f)) * t1;
                    oiter += hogStride;
                    *oiter = (1.0f / sqrtf(18.0f)) * t2;
                    oiter += hogStride;
                    *oiter = (1.0f / sqrtf(18.0f)) * t3;
                    oiter += hogStride;
                    *oiter = (1.0f / sqrtf(18.0f)) * t4;
                    oiter += hogStride;
                    break;
