...
#ifdef _MSC_VER
/**
 * @FilePath     : /cola/cola/Vision/Ml/SVM/svm.cpp
 * @Description  :
 * @Author       : naonao
 * @Date         : 2024-07-18 19:10:35
 * @Version      : 0.0.1
 * @LastEditors  : naonao
 * @LastEditTime : 2024-07-20 12:18:02
 **/
...
void Solver::Solve(int l, const QMatrix& Q, const double* p_, const schar* y_, double* alpha_, double Cp, double Cn, double eps, SolutionInfo* si, int shrinking)
{
    this->l = l;
    this->Q = &Q;
    QD      = Q.get_QD();
